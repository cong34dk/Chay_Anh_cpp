...
//Vào trang web : https://www.ascii-art-generator.org/ để chuyển ảnh sang file .txt
...
int main()
{
	...
	while (true)
	{
		system("cls");
		cout << endl << endl;
		cout << "\t\tNGUOI TRONG ANH LA AI ? ";
		getline(cin, name);
		if (name == "cong")
		{
			cout << "\t\t---CHINH XAC!---" << endl <<endl;
			cout << "\t\tCONG DEP TRAI OK..." << endl;
			Sleep(1000);
			cout << "\t\tCONG DEP TRAI OK..." << endl; Sleep(100);
			cout << "\t\tCONG DEP TRAI OK..." << endl; Sleep(100);
			cout << "\t\tCONG DEP TRAI OK..." << endl; Sleep(100);
			cout << "\t\tCONG DEP TRAI OK..." << endl; Sleep(100);
			cout << "\t\tCONG DEP TRAI OK..." << endl; Sleep(100);
			...
			cout << "\t\tCONG DEP TRAI OK..." << endl; Sleep(100);
			cout << "\t\tCONG DEP TRAI OK..." << endl; Sleep(100);
			cout << "\t\tCONG DEP TRAI OK..." << endl << endl;
			...
			while(true)
			{
				...
				ifstream file;
				file.open("D:\\vda\\cong_it\\chay_anh_c++\\banner.txt", ios_base::in); //import file thì copy đường dẫn rồi đổi \ thành \\ hoặc /
				string line;
		...
		{
			cout << "\t\tSAI ROI NHAP LAI DI BAN OI" << endl << endl;
			system("pause");
		}
	}
}
